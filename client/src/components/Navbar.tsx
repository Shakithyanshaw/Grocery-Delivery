            ...
            <form className="hidden sm:flex flex-1 max-w-sm text-xs sm:text-sm">
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full pl-8 p-2 bg-orange-50 ring ring-app-orange/15 focus:ring-app-orange/30"
                />
              </div>
            </form>
            {/*Right Actions*/}
              ...
              <div className="relative">
                {user ? (
                  ...
                  <div className="flex-center gap-2">
                    <Link
                      to="/login"
                      className="hiddenn md:flex items-center  gap-2 px-4 py-2 text-sm font-medium text-white bg-green-950 rounded-full hover:bg-green-950-light transition-colors"
                    >
                      ...
                      <div onClick={() => setUserMenuOpen(false)}>
                        ...
                        {user?.isAdmin && (
                          <Link
                            ...
                            className="dropdown-link md:hidden"
                          >
                            <ShieldIcon size={16} className="text-app-orange" />
